...
import { BookOpen, Compass, Home, LibraryBig, MessageCircle, Sparkles, TrendingUp, Zap, LogOut, User, Menu, X } from "lucide-react";
...
const navItems = [
  ...
  { path: "/curriculum", label: "10K Path", icon: LibraryBig },
